(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".swipers")) new swiper_core_Swiper(".swipers", {
        ...
        if (document.querySelector(".swiper-prod")) new swiper_core_Swiper(".swipers-prod", {
            modules: [ Navigation, HashNavigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    document.querySelectorAll('[id="horizontal-scroller"]').addEventListener("wheel", (function(event) {
